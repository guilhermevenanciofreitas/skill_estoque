      ...
      <>
        ...
        <PageContent>
          ...
          <Stack direction='row' alignItems='flexStart' justifyContent='space-between'>
            ...
            <div>
              <Button appearance='primary' color='blue' startIcon={<FaUpload />} onClick={this.onNovoTipoEntSai}>&nbsp;Novo</Button>
              <Button appearance='primary' color='blue' startIcon={<FaUpload />} disabled={_.size(this.state?.selecteds) != 1} style={{marginLeft: '10px'}} onClick={() => this.onEditarTipoEntSai(this.state?.selecteds[0]?.codentsai)}>&nbsp;Editar</Button>
